...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DZei0WHq.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-BpKtBDtA.js").then((n) => n.r),
...
var ROUTER_BASEPATH = "coliseum-gladiators";
var SERVER_FN_BASE = "/coliseum-gladiators/_serverFn/";
