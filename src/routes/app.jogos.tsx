    ...
    <div className="mx-auto max-w-5xl space-y-6">
      <header>
        ...
        <p className="text-sm text-muted-foreground">
          {isCoach
            ? "Acompanhe convocações e confirmações do elenco."
            : "Confirme sua presença em cada compromisso."}
        </p>
      </header>
      ...
      <div className="grid gap-3">
        {events.map((e) => {
          ...
          return (
            <Card
              key={e.id}
              className={isGame ? "border-accent/40" : undefined}
            >
