export type PlayPosition = {
  ...
  // Coordenadas iniciais em % do campo (0–100)
  x: number;
  y: number;
  // Coordenadas finais (após o snap). Se omitidas, jogador permanece parado.
  endX?: number;
  endY?: number;
...
export type Play = {
  ...
  description: string;
  bullets: string[]; // explicação em bullet points editável pelo coach
